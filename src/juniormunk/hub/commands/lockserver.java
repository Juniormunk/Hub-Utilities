...
public class lockserver implements CommandExecutor
{
	Main main;

	public lockserver(Main main)
	{
		this.main = main;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
	{
		...
		if (args.length != 1)
		{
			sender.sendMessage(ChatColor.RED + "Incorrect command use! /lockserver <server>");
			return true;
		}
		...
		Server.getServerByName(args[0]).setLocked(true);
		sender.sendMessage(ChatColor.AQUA + "You have locked " + args[0]);
